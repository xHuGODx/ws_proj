...
\begin{itemize}[leftmargin=1.5em]
  \item Extend the admin panel to manage race results directly (changing positions,
        points, and status for individual entries).
  ...
  \item Inlcude and AI that allows users to ask natural language questions about the data, translating them
        into SPARQL queries under the hood.
\end{itemize}
